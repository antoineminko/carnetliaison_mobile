...
extension OverviewTabExtension on _ChildDetailsViewState {
  Widget _buildOverviewTab() {
    ...
    String rawStatus = widget.child['attendance_status']?.toString().toLowerCase() ?? '';
    String status;
    ...
    // Icône statut
    IconData statusIcon;
    if (isPresent) statusIcon = Icons.check_circle;
    else if (isAbsent) statusIcon = Icons.cancel;
    else if (isLate) statusIcon = Icons.watch_later;
    else statusIcon = Icons.hourglass_empty_rounded;
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                // Séparateur
                Container(width: 1, height: 50, color: accentColor.withOpacity(0.2)),
          ...
          Container(
            ...
            child: Row(
              children: [
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          fontSize: 18,
                          fontWeight: FontWeight.bold,
                          color: isWaiting ? Colors.grey[700] : box2AccentColor,
                        ),
                      ),
                ...
                // Séparateur
                Container(width: 1, height: 50, color: box2AccentColor.withOpacity(0.2)),
                const SizedBox(width: 16),
                // Jour
                Expanded(
                  child: Column(
