...
import 'package:app_mobile/features/teacher/espace_classe/attendance/attendance_view.dart';
import 'package:app_mobile/features/teacher/espace_classe/textbook/textbook_view.dart';
import 'package:app_mobile/features/teacher/espace_classe/students/teacher_student_list_page.dart';
import 'package:app_mobile/features/teacher/messages/teacher_messages_page.dart';
import 'package:app_mobile/features/teacher/espace_classe/grades/grades_entry_view.dart';
import 'package:app_mobile/shared/theme/app_theme.dart';

class EspaceClassePage extends StatefulWidget {
  final int classId;
  ...
  @override
  State<EspaceClassePage> createState() => _EspaceClassePageState();
}

class _EspaceClassePageState extends State<EspaceClassePage> {
  @override
                              ...
                              content: Column(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: const Icon(Icons.handyman_rounded, color: Colors.orange, size: 50),
                                  ),
                                  ...
                                  const Text(
                                    'La gestion complète des résultats scolaires sera bientôt disponible.',
                                    style: TextStyle(
                                      fontSize: 14,
                                      color: AppTheme.textGrey,
                                    ),
